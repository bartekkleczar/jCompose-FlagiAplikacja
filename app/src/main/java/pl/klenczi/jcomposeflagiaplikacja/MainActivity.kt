...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            Main(countriesList,
                setOf(
                    r.getString(R.string.color_white),
                    r.getString(R.string.color_red),
                    r.getString(R.string.color_yellow),
                    r.getString(R.string.color_blue),
                    r.getString(R.string.color_black),
                    r.getString(R.string.color_orange),
                    r.getString(R.string.color_green)
                ),
                setOf(
                    r.getString(R.string.orientation_horizontal),
                    r.getString(R.string.orientation_vertical),
                    r.getString(R.string.shape_cross),
                    r.getString(R.string.shape_other)
                ),
                mapOf(
